...
public class Calibrate extends LinearOpMode {
    ...
    Double bias = .717;//adjust until your robot goes 20 inches
    //
    ...
    public void runOpMode() {
        ...
        frontleft.setDirection(DcMotorSimple.Direction.REVERSE);//If your robot goes backward, switch this from left to right
        backleft.setDirection(DcMotorSimple.Direction.REVERSE);//If your robot goes backward, switch this from left to right
        //
        waitForStartify();
        //
