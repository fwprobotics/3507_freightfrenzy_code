...
public class RedRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //
        if (cupPos == CupPosition.LEFT) {
            moveToPosition(21.75, 0.2);
            claw.openClaw();
            moveToPosition(-6, 0.2);
            turnWithGyro(90, 0.2);
        } else if (cupPos == CupPosition.MIDDLE) {
            moveToPosition(22.5, 0.2);
            claw.openClaw();
            sleep(250);
            moveToPosition(-6, 0.2);
            turnWithGyro(90, 0.2);
            ...
            claw.openClaw();
            sleep(250);
            turnWithGyro(270, 0.2);
        }
        //

        //
        strafeToPosition(33, 0.4);
        //
        moveToPosition(60, 0.4);
        //
    }
    ...
    private void initCV() {
        ...
        pipeline = new Pipeline(125, 165, 80, -5); //Pipeline(first x, first y, shift x for a new box, shift y for a new box)
